        ...
        <div class="container-fluid px-4">
            <div class="card my-4 headercard">
                <div class="list-header px-3 py-2">
                    <div>
                        <h2 class="text-white"><i class="icofont-list"></i>Subcategory</h2>
                    </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-6">
                                                <label for="category_code" class="form-label">SubCategory Code</label>
                    ...
                    <div class="tile-body">
                        ...
                        <table id="datatablesSimple">
                            ...
                            <tbody id="filter_data">
                                ...
                                <tr>
                                    <td></td>
                                    <td><img src="" class="img-fluid" style="width: 170px; object-fit: cover;"></td>
                                    <td>dd</td>
                                    <td>00</td>
                                    <td><a href="#" class="btn btn-warning">
                                        ...
                                        <form action="# " method="POST" class="d-inline-block" onsubmit="return confirm('Are you sure to delete the item?')">
                                            @csrf
                                            @method('DELETE')
