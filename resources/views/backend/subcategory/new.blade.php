        ...
        <div class="container-fluid px-4">
            <div class="card my-4 headercard">
                <div class="list-header px-3 py-2">
                    <div>
                        <h2 class="text-white"><i class="icofont-list"></i>SubCategory Form</h2>
                    </div>
                    ...
                    <form action="{{route('subcategory.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="text-danger form-control-feedback">
                                    {{$errors->first('subcategory_code') }} {{-- error array khan htae ka first array ko htoke chin --}}
                                </div>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="categoryid" class="col-sm-2 col-form-label text-white">Category</label>
                            <div class="col-sm-10">
